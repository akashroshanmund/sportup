...
data class PlayerApiModel (
    @SerializedName("player" ) var playersList : ArrayList<playersItem> = arrayListOf()
)
...
data class playersItem (
    ...
    @SerializedName("idTeam2"            ) var idTeam2            : String? = null,
    @SerializedName("idTeamNational"     ) var idTeamNational     : String? = null,
    ...
    @SerializedName("idWikidata"         ) var idWikidata         : String? = null,
    @SerializedName("strNationality"     ) var strNationality     : String? = null,
    @SerializedName("strPlayer"          ) var strPlayer          : String? = null,
    @SerializedName("strPlayerAlternate" ) var strPlayerAlternate : String? = null,
    @SerializedName("strTeam"            ) var strTeam            : String? = null,
    @SerializedName("strTeam2"           ) var strTeam2           : String? = null,
    @SerializedName("strSport"           ) var strSport           : String? = null,
    @SerializedName("intSoccerXMLTeamID" ) var intSoccerXMLTeamID : String? = null,
    @SerializedName("dateBorn"           ) var dateBorn           : String? = null,
    @SerializedName("strNumber"          ) var strNumber          : String? = null,
    ...
    @SerializedName("strOutfitter"       ) var strOutfitter       : String? = null,
    @SerializedName("strKit"             ) var strKit             : String? = null,
    @SerializedName("strAgent"           ) var strAgent           : String? = null,
    @SerializedName("strBirthLocation"   ) var strBirthLocation   : String? = null,
    @SerializedName("strEthnicity"       ) var strEthnicity       : String? = null,
    ...
    @SerializedName("strSide"            ) var strSide            : String? = null,
    @SerializedName("strPosition"        ) var strPosition        : String? = null,
    @SerializedName("strCollege"         ) var strCollege         : String? = null,
    ...
    @SerializedName("strRender"          ) var strRender          : String? = null,
    @SerializedName("strBanner"          ) var strBanner          : String? = null,
    @SerializedName("strFanart1"         ) var strFanart1         : String? = null,
    @SerializedName("strFanart2"         ) var strFanart2         : String? = null,
    @SerializedName("strFanart3"         ) var strFanart3         : String? = null,
    @SerializedName("strFanart4"         ) var strFanart4         : String? = null,
    @SerializedName("strCreativeCommons" ) var strCreativeCommons : String? = null,
